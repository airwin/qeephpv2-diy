 ...
 * @package mvc
 */
class QView_Render_PHP implements ArrayAccess
{
    /**
     * 视图分析类名
     *
     ...
     * 设置视图对象
     *
     * @param QView_Render_PHP_Parser $parser
     *
     * @return QView_Render_PHP
     */
    function setParse($parser)
    {
        $this->_parser = $parser;
        return $this;
    }
     ...
     * @return QView_Render_PHP
     */
    function setParserName($parser_name)
    {
        $this->_parser_name = $parser_name;
        return $this;
    }
    ...
    function execute()
    {
        ...
        return $this->fetch($this->_viewname);
    }
    ...
    {
        return $this->assign($prop_name, $value);
    }
    ...
    {
        return array_key_exists($prop_name, $this->_vars);
    }
...
class QView_Render_PHP_Parser
{
    ...
    function parse($filename, $view_id = null, array $inherited_stack = null)
    {
        ...
        if (is_array($inherited_stack))
        {
            ...
            {
                if (!empty($inherited_stack['blocks_config'][$block_name]))
                {
                    switch (strtolower($inherited_stack['blocks_config'][$block_name]))
                    {
                    case 'append':
