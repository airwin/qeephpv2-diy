...
class QDB_Select
{
    ...
    {
        $this->_query_params[self::AS_COLL] = (boolean) $as_coll;
        return $this;
    }
     ...
     * @return mixed
     */
    function toHashMap($key_name, $value_name = null, $included_links = null)
    {
        $rows = $this->getAll($included_links);
        if ($this->_query_params[self::AS_ARRAY])
        {
            return Helper_Array::toHashMap($rows, $key_name, $value_name);
        }
        return $rows->toHashMap($key_name, $value_name);
    }
